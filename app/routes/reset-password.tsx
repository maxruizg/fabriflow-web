    ...
    <div className="min-h-screen grid lg:grid-cols-[1.1fr_1fr] bg-background">
      ...
      <main className="relative flex items-center justify-center p-6 lg:p-12">
        ...
        <div className="w-full max-w-[420px]">
          ...
          <h1 className="ff-page-title">
            Define una <em>nueva contraseña</em>
          </h1>
          <p className="ff-page-sub mb-8">
            Elige una contraseña segura de al menos 8 caracteres para proteger
            tu cuenta.
          </p>
  ...
  return (
    <div className="relative z-10 max-w-[480px]">
      ...
      <h2 className="font-display text-[44px] leading-[1.05] font-medium tracking-tight">
        Define una
        <br />
        <em className="text-clay">nueva contraseña.</em>
      </h2>
      <p className="mt-5 text-[14px] text-ink-2 leading-relaxed">
        Una contraseña robusta protege tus órdenes de compra, facturas y datos
        de conciliación. Elige algo único y seguro.
      </p>
