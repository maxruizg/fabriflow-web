...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto">
    <table
      ref={ref}
      className={cn("ff-table w-full caption-bottom", className)}
      {...props}
    />
  </div>
));
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn("bg-paper-2 font-medium [&>tr]:last:border-b-0", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "data-[state=selected]:bg-paper-3 transition-colors",
      className,
    )}
    {...props}
  />
